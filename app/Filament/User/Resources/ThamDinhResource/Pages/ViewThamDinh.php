                                ...
                                TextEntry::make('taiLieuSangKien')
                                    ...
                                    ->formatStateUsing(function ($record) {
                                        if (!$record->taiLieuSangKien || $record->taiLieuSangKien->isEmpty()) {
                                            return '
                                                <div class="flex items-center justify-center p-6 text-center bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
                                                    <div class="text-gray-500 italic">
                                                        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                                                        </svg>
                                                        <p class="mt-2">Không có tệp đính kèm</p>
                                                    </div>
                                                </div>';
                                        }
                                        ...
                                        // Hiển thị số lượng file và tổng dung lượng
                                        $html .= '
                                    ...
                                    ->formatStateUsing(function ($state) {
                                        return "
                                            <div class='space-y-1'>
                                                ...
                                                <div class='text-sm text-gray-500'>{$state->donVis->first()?->ten_don_vi}</div>
                                            </div>
                                        ";
                                    })
                                    ->html(),
                                    ...
                                    ->formatStateUsing(function ($record) {
                                        ...
                                        return "
                                            <div class='flex flex-col items-center justify-center p-3 bg-gray-50 rounded-lg'>
                                                <div class='text-2xl font-bold'>{$approvedCount}/{$totalMembers}</div>
                                                <div class='text-sm text-gray-500'>Tỷ lệ: {$percentage}%</div>
                                            </div>
                                        ";
                                    })
                                    ->html(),
                                        ...
                                        TextEntry::make('hoiDongThamDinh.thanhVienHoiDongs')
                                            ...
                                            ->formatStateUsing(function ($record) {
                                                ...
                                                if ($approvedMembers->isEmpty()) {
                                                    return '<div class="text-gray-500 italic">Chưa có thành viên nào duyệt</div>';
                                                }
                                                ...
                                                foreach ($approvedMembers as $member) {
                                                    $html .= "
                                                        <div class='flex items-center p-2 bg-green-50 rounded-lg'>
                                                            <div class='flex-1'>
                                                                <div class='font-medium text-green-700'>{$member->user->name}</div>
                                                                <div class='text-sm text-green-600'>{$member->user->donVis->first()?->ten_don_vi}</div>
                                                            </div>
                                                            <div class='flex-shrink-0'>
                                        ...
                                        TextEntry::make('hoiDongThamDinh.thanhVienHoiDongs')
                                            ...
                                            ->formatStateUsing(function ($record) {
                                                ...
                                                if ($pendingMembers->isEmpty()) {
                                                    return '<div class="text-gray-500 italic">Không có thành viên nào chờ duyệt</div>';
                                                }
                                                ...
                                                foreach ($pendingMembers as $member) {
                                                    $html .= "
                                                        <div class='flex items-center p-2 bg-gray-50 rounded-lg'>
                                                            <div class='flex-1'>
                                                                <div class='font-medium text-gray-700'>{$member->user->name}</div>
                                                                <div class='text-sm text-gray-600'>{$member->user->donVis->first()?->ten_don_vi}</div>
                                                            </div>
                                                            <div class='flex-shrink-0'>
                                                                <svg class='w-5 h-5 text-gray-400' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
